...
image = random_adjust(data_dir,str(data[0][1100][0]),str(data[0][1100][1]),str(data[0][1100][2]), steering_angle)
...
# **Lamda_function** Normalizing the images (by dividing image data by 127.5 and subtracting 1.0). As stated in the Model Architecture section, this is to avoid saturation and make gradients work better).
